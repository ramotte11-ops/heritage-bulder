...
export const fr: Partial<Record<TranslationKey, string>> = {
  ...
  "deathNotice.previewTitle": "Avis de décès",
  "deathNotice.blockLocation": "Lieu général",
  "deathNotice.blockFamilyMessage": "Mot de la famille",
  "deathNotice.blockThought": "Pensée",
  "deathNotice.blockQuote": "Citation",
  ...
  "ceremony.momentTitle": "Un moment est-il prévu ?",
  "ceremony.momentSubtitle": "Vous pourrez préciser les détails ensuite, ou revenir plus tard.",
  "ceremony.momentYes": "Oui",
  "ceremony.momentUndecided": "Pas encore décidé",
  "ceremony.momentNo": "Non",
  "ceremony.dateTimeTitle": "Quand aura lieu ce moment ?",
  "ceremony.dateTimeSubtitle": "La date, l'heure, ou les deux si vous les connaissez déjà.",
  "ceremony.dateLabel": "Date",
  "ceremony.timeLabel": "Heure",
  "ceremony.venueTitle": "Où aura lieu ce moment ?",
  "ceremony.venueSubtitle": "Le nom du lieu suffit pour l'instant.",
  "ceremony.venueLabel": "Nom du lieu",
  "ceremony.addressTitle": "Adresse et accès",
  "ceremony.addressSubtitle": "De quoi permettre à chacun de s'y rendre sereinement.",
  "ceremony.addressLabel": "Adresse",
  "ceremony.accessLabel": "Accès / indications pratiques",
  "ceremony.noteTitle": "Une note pratique ?",
